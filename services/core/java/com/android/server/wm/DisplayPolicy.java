...
public class DisplayPolicy {
    ...
    public void onConfigurationChanged() {
        ...
        final int uiMode = mService.mPolicy.getUiMode();
        final boolean showNavbar = PixeldustUtils.shouldSetNavbarHeight(mContext);
    ...
    private boolean gestureNavbarHidden() {
        boolean isGestureNavbar = (PixeldustUtils.isThemeEnabled("com.android.internal.systemui.navbar.gestural")
                || PixeldustUtils.isThemeEnabled("com.android.internal.systemui.navbar.gestural_wide_back")
                || PixeldustUtils.isThemeEnabled("com.android.internal.systemui.navbar.gestural_extra_wide_back")
                || PixeldustUtils.isThemeEnabled("com.android.internal.systemui.navbar.gestural_narrow_back"));
