...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    private void handleThemeStates(boolean themeNeedsRefresh) {
        ...
        boolean useSNTheme = themeMode == 4;
    ...
    private boolean themeNeedsRefresh(){
        if (mContext.getSharedPreferences("systemui_theming", 0).getString(
                "build_fingerprint", "").equals(Build.PIXELDUST_FINGERPRINT)){
            return false;
        }
        mContext.getSharedPreferences("systemui_theming", 0).edit().putString(
                "build_fingerprint", Build.PIXELDUST_FINGERPRINT).commit();
        return true;
    }
    ...
    private class CustomSettingsObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            if (uri.equals(Settings.System.getUriFor(Settings.System.LOCKSCREEN_CLOCK)) ||
    ...
    private void updateBlacklistSettings() {
    ...
    private void setAmbientVis() {
        mAmbientVisualizer = Settings.Secure.getIntForUser(mContext.getContentResolver(),
