...
public class QuickQSPanel extends QSPanel {
    ...
    public QuickQSPanel(Context context, AttributeSet attrs) {
        ...
        portraitValue = PixeldustUtils.getQuickQSColumnsPortrait(mContext, portraitValue);
        ...
        mMaxColumnsLandscape = PixeldustUtils.getQuickQSColumnsPortrait(mContext, mMaxColumnsLandscape);
    ...
    static class QQSSideLabelTileLayout extends SideLabelTileLayout {
        ...
        public int getResourceColumnsPortrait() {
            ...
            return PixeldustUtils.getQuickQSColumnsPortrait(mContext, resourceColumns);
        }
