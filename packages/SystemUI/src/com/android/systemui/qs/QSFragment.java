...
public class QSFragment extends LifecycleFragment implements QS, CommandQueue.Callbacks,
    ...
    private final class SettingObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            if (uri.equals(Settings.System.getUriFor(Settings.System.QS_BRIGHTNESS_SLIDER_FOOTER))) {
                update();
            } if (mFooterBrightnessSlider && uri.equals(Settings.System.getUriFor(Settings.System.SCREEN_BRIGHTNESS))) {
                updateBrightnessSliderProgress(Settings.System.getInt(mContext.getContentResolver(),
                Settings.System.SCREEN_BRIGHTNESS, 0));
            }
        }
        ...
        public void update() {
            mFooterBrightnessSlider = Settings.System.getIntForUser(mContext.getContentResolver(),
                Settings.System.QS_BRIGHTNESS_SLIDER_FOOTER, 0, UserHandle.USER_CURRENT) != 0;
            updateBrightnessSliderVisibility(mFooterBrightnessSlider);
        }
    }
}
