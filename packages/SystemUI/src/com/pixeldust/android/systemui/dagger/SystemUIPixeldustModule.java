...
public abstract class SystemUIPixeldustModule {
    ...
    @Provides
    @SysUISingleton
    static PixeldustServices providePixeldustServices(Context context, UiEventLogger uiEventLogger, Lazy<ColumbusServiceWrapper> lazy) {
        return new PixeldustServices(context, uiEventLogger, lazy);
    }
