...
public class Dependency {
    ...
    public static final String COLUMBUS_BLOCKING_SYSTEM_KEYS = "columbus_blocking_system_keys";
    public static final String COLUMBUS_ACTIONS = "columbus_actions";
    public static final String COLUMBUS_FULL_SCREEN_ACTIONS = "columbus_full_screen_actions";
